					...
					<table>
							...
							<td colspan="2">
								<div class="topmenu">
									<ul class="menu-wrap">
										...
										<li id="site5" class="site"><a href="best?action=list&site=y&category=소설"><b>YES24</b></a></li>
									</ul>									
								</div>
							</td>
							<td width="20"></td>
						...
						<tr>
							...
							<td class="submenu" colspan="2">
								<ul>
									<li><a href="best?action=list&site=y&category=소설">소설</a></li>
									<li><a href="best?action=list&site=y&category=자기계발">자기계발</a></li>
									<li><a href="best?action=list&site=y&category=에세이">에세이</a></li>
									<li><a href="best?action=list&site=y&category=과학">과학</a></li>
									<li><a href="best?action=list&site=y&category=인문">인문</a></li>
									<li><a href="best?action=list&site=y&category=컴퓨터">컴퓨터</a></li>
									<li><a href="best?action=list&site=y&category=청소년">청소년</a></li>
								</ul>
							</td>
							<td width="20"></td>
						</tr>
						...
						<tr>
							...
							<td class="submenu">
								<ul>
									<li><a href="best?action=list_2&site=y&age=1">10대</a></li>
									<li><a href="best?action=list_2&site=y&age=2">20대</a></li>
									<li><a href="best?action=list_2&site=y&age=3">30대</a></li>
									<li><a href="best?action=list_2&site=y&age=4">40대</a></li>
									<li><a href="best?action=list_2&site=y&age=5">50대</a></li>
									<li><a href="best?action=list_2&site=y&age=6">60대 이상</a></li>
								</ul>
							</td>
							<td>
								<span>
									...
									<select class="gender" onchange="if(this.value) location.href=(this.value);">
										<option value="best?action=list_3&site=y&gender=1" <%=gender.equals("1")||gender==null?"selected":""%>>전체</option>
										<option value="best?action=list_3&site=y&gender=2" <%=gender.equals("2")?"selected":""%>>남자</option>
										<option value="best?action=list_3&site=y&gender=3" <%=gender.equals("3")?"selected":""%>>여자</option>
									</select>
								</span>
							</td>
							<td width="20"></td>
