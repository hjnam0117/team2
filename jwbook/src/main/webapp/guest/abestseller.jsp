					...
					<table>
							...
							<td colspan="2">
								<div class="topmenu">
									<ul class="menu-wrap">
										...
										<li id="site2" class="site"><a href="best?action=listA&category=소설"><b>알라딘</b></a></li>
						...
						<tr>
							...
							<td class="submenu" colspan="2">
								<ul>
									<li><a href="best?action=listA&category=소설">소설</a></li>
									<li><a href="best?action=listA&category=자기계발">자기계발</a></li>
									<li><a href="best?action=listA&category=에세이">에세이</a></li>
									<li><a href="best?action=listA&category=과학">과학</a></li>
									<li><a href="best?action=listA&category=인문">인문</a></li>
									<li><a href="best?action=listA&category=컴퓨터">컴퓨터</a></li>
									<li><a href="best?action=listA&category=청소년">청소년</a></li>
								</ul>
							</td>
							<td width="20"></td>
						</tr>
